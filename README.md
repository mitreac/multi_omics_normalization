...
4. Using you preferred coding IDE, do the exercises!
...
6. Check the status of your repo with:        
git status

7. Add and commit the change(s):
...
9. Create a pull request agains the mitreac repo you forked.
...
10. Check that your pull request is in the list of the repo's pull requests:       
